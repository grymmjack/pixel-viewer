// Authentic IBM VGA 8x8 CP437 font (the 80x50 / VGA50 text-mode ROM font). 256
// glyphs, 8x8; one byte per row (bit 7 = leftmost pixel), indexed by CP437 byte
// value. Public-domain IBM ROM bitmap (via spacerace/romfont, IBM_VGA_8x8), the
// 8-row companion to the 8x16 font in cp437_font.rs — used when SAUCE names an 8x8
// font ("IBM VGA50", "IBM EGA43", etc.), where each cell is 8x8 not 8x16.
#[rustfmt::skip]
pub const CP437_8X8: [[u8; 8]; 256] = [

// Authentic IBM VGA 8x16 CP437 font. 256 glyphs, 8x16; one byte per row
// (bit 7 = leftmost pixel), indexed by CP437 byte value.
//
// Glyph data from the IBM VGA ROM font (a public-domain bitmap), transcribed
// via susam/pcface (out/oldschool-vga-8x16). Replaces the previous
// Terminus-Bold-VGA derivation, whose heavier glyphs rendered ANSI text cramped.
#[rustfmt::skip]
